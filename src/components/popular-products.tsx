...
function adaptProduct(backendProduct: ApiProduct): Product {
    ...
    const primaryImage = getProductImageUrl(primary ?? null);
            ...
            <section className="w-full py-10 md:py-12 bg-gray-50">
                <div className="w-full mx-auto px-4 md:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-10 md:mb-12">
                        <h2 className="text-xl md:text-2xl xl:text-3xl font-extrabold text-[#253D4E]">Popular Products</h2>
                    </div>
        ...
        <section className="w-full py-6 md:py-12 bg-gray-50">
            <div className="w-full mx-auto px-4 md:px-6 lg:px-8">
                ...
                <div className="flex items-center justify-between gap-3 mb-6 md:mb-12">
                    <h2 className="text-lg md:text-2xl xl:text-3xl 2xl:text-[2rem] font-extrabold text-[#253D4E] leading-tight">Popular Products</h2>
                    <Link
                        href="/shop"
                ...
                {/* Desktop: 3–5 columns */}
                <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5 md:gap-6 xl:gap-6">
                ...
                <div className="grid grid-cols-2 md:hidden gap-2.5 sm:gap-3">
                    {products.map((product) => (
