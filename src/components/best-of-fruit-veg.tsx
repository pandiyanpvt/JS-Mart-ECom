                    ...
                    <div key={product.id} className="flex-shrink-0 group min-w-[270px]">
                        <div className="bg-white rounded-lg border border-gray-200 transition-all duration-300 hover:shadow-xl relative overflow-hidden">
                            <div className="relative bg-gray-50 p-4">
                                ...
                                {product.isNew && (
                                    <div className="absolute top-3 left-3 z-10">
                                        <span className="bg-[#005000] text-white text-xs font-bold px-2.5 py-1 rounded">
                                            NEW
                                        </span>
                                    </div>
                                )}
                            ...
                            <div className="p-4 space-y-2">
                                <Link href={`/shop/${product.id}`}>
                                    <h3 className="text-[#253D4E] font-semibold text-sm leading-tight hover:text-[#005000] transition-colors">
                                        {product.name}
                                    </h3>
                                </Link>
