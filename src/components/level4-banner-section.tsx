...
export default function Level4BannerSection() {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
            try {
                ...
                const promotions = await promotionService.getByLevel(4);
                setBanners(promotions.sort((a, b) => a.order - b.order));
            } catch (error) {
                console.error("Failed to load level 4 banners:", error);
                setBanners([]);
            } finally {
                setLoading(false);
            }
                    ...
                    {banners.length > 1 && (
                        <>
                            <button
                                ...
                                aria-label="Previous seasonal banner"
                            >
                            ...
                            <button
                                ...
                                aria-label="Next seasonal banner"
                            >
