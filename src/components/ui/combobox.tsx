...
export function Combobox<T>({
  ...
  multiple?: boolean; // Add this prop
    ...
    >
      <span
        ...
        className={clsx([
          ...
          "dark:before:hidden",
          // Focus ring
          "after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-cyan-600",
          // Disabled state
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={clsx(
        ...
        // Focus
        "outline-hidden data-focus:bg-cyan-600 data-focus:text-white",
        // Forced colors mode
