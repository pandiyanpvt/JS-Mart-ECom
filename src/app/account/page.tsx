    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-lime-500 to-lime-600 rounded-xl shadow-md p-8 text-white">
                    <h3 className="text-xl font-bold mb-2">Need Help?</h3>
                    <p className="text-lime-100 mb-4">
                        Our support team is ready to assist you
                    </p>
                    <button className="bg-white text-lime-600 px-6 py-2 rounded-lg font-semibold hover:bg-lime-50 transition-colors">
                        Contact Support
                    </button>
                </div>

                <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-md p-8 text-white">
