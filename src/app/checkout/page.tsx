...
import { ShoppingBag, Loader2, MapPin, Plus } from "lucide-react";
...
const CheckoutPage = () => {
    ...
    if (!authChecked) {
        return (
            <div className="min-h-screen bg-gray-50 pt-[120px] pb-12 flex items-center justify-center">
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                        ...
                        <div className="space-y-3 pt-6 border-t border-gray-200">
                            <h3 className="font-extrabold text-[#253D4E] text-sm">Payment method</h3>
                        ...
                        <Button
                            ...
                            disabled={loading}
                            className="w-full h-12 bg-[#005000] hover:bg-[#006600] text-white font-bold text-base rounded-lg disabled:opacity-70 disabled:cursor-not-allowed mt-6"
                        >
                            {loading ? (
                                <>
